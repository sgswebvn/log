...
INSERT INTO news_categories (name_vi, name_en, slug, description_vi, description_en, color, icon, display_order) VALUES
('Tin công ty', 'Company News', 'company', 'Tin tức về hoạt động và phát triển của công ty', 'News about company activities and development', '#3B82F6', 'Building2', 1),
('Khuyến mại', 'Promotions', 'promotions', 'Các chương trình khuyến mại và ưu đãi', 'Promotional programs and special offers', '#10B981', 'Gift', 2),
('Triển lãm', 'Exhibitions', 'exhibitions', 'Tham gia các triển lãm và sự kiện ngành', 'Participation in industry exhibitions and events', '#8B5CF6', 'Calendar', 3),
('Truyền thông', 'Media', 'media', 'Tin tức truyền thông và báo chí', 'Media and press news', '#F59E0B', 'Tv', 4),
('Dữ liệu ngành', 'Industry Data', 'industry', 'Thống kê và phân tích dữ liệu ngành logistics', 'Logistics industry statistics and analysis', '#EF4444', 'BarChart3', 5);
...
'/china-europe-freight.png', 3, true, true, 'global-transport-connectivity-forum-2025'),
