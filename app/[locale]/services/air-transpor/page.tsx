    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <section className="relative h-72 md:h-96 flex items-center justify-center overflow-hidden">
                <Image src="/images/services/air-pay.png" alt={t("hero.title")} fill className="object-cover" priority />
            ...
            <main className="container mx-auto px-4 py-12 md:py-20 grid md:grid-cols-3 gap-8">
                ...
                <article className="md:col-span-2 bg-white rounded-2xl shadow-md p-8 text-left">
                    <Image
                        src="/images/services/air-pay2.png"
                        alt={t("content.title")}
                        width={700}
                        height={400}
                    ...
                    <p className="text-gray-700 mb-4">{t("content.intro")}</p>

                    {/* Tốc độ và thời gian giao hàng */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.speed.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.speed.desc")}</p>
                    </div>

                    {/* An toàn và bảo đảm chất lượng */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.safety.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.safety.desc")}</p>
                    </div>

                    {/* Phạm vi vận chuyển */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.scope.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.scope.desc")}</p>
                    </div>

                    {/* Dịch vụ khách hàng và hỗ trợ */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.customerService.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.customerService.desc")}</p>
                    </div>

                    {/* Giải pháp vận chuyển linh hoạt */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.flexibleSolution.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.flexibleSolution.desc")}</p>
                    </div>

                    {/* Công nghệ và quản lý thông minh */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.technology.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.technology.desc")}</p>
                    </div>

                    {/* Sự tận tâm và cam kết */}
                    <div className="mb-8">
                        <h3 className="text-xl font-semibold mb-4">{t("content.commitment.title")}</h3>
                        <p className="text-gray-700 mb-4">{t("content.commitment.desc")}</p>
                    </div>
