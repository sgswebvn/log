...
function RoutePanel({ title, items, align = 'left' }: { title: string; items: string[]; align?: 'left' | 'right' }) {
  return (
      ...
      {align === 'left' ? (
        <>
          ...
          <div className="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-8 flex flex-col justify-center">
            <div className="uppercase tracking-wide text-white/80 text-xs">NEP EXPRESS</div>
...
export default function ServicesRoutes() {
  ...
  return (
    <div id="services">
      <RoutePanel title="Xian–Moscow Express" items={t.raw('xianMoscow') as string[]} align="left" />
